...
Lemma meow_meow (A B:Type) (P:prod' A B) : to_prod_alt3 P = to_prod P.
destruct P as [L R]. reflexivity.
Qed.
...
Record group := {
  mono : monoid ; 
  inv : mono.m_ty -> mono.m_ty ;
  comm : forall x y, mono.m_op x y = mono.m_op y x;
  inv_l : forall x, mono.m_op x (inv x) = mono.m_ne;
}.
...
Proof.
  ...
  |}
Admitted. (* We need Defined to access the fields! *)
